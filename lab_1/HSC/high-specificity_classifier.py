...
# Create a decision tree classifier with max depth of 3 (for example)
...
# Set threshold to achieve high specificity (for example)
threshold = 0.9

# Convert predicted probabilities to binary predictions based on threshold value
...
# plt.show()
plt.savefig('HSC_precision_recall_curve.png')
